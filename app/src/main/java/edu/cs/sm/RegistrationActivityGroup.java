...
public class RegistrationActivityGroup extends AppCompatActivity {
    ...
    String url = "http://192.168.1.7/makegroups/register.php";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_registration_group);
        ...
        if(ed_username.getText().toString().equals("")){
            ...
            StringRequest request = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    ...
                    ed_email.setText("");
                    ed_password.setText("");
                    Toast.makeText(RegistrationActivityGroup.this, response, Toast.LENGTH_SHORT).show();
                }
                ...
                public void onErrorResponse(VolleyError error) {
                    progressDialog.dismiss();
                    Toast.makeText(RegistrationActivityGroup.this, error.getMessage().toString(), Toast.LENGTH_SHORT).show();
                }
            }
            ...
            RequestQueue requestQueue = Volley.newRequestQueue(RegistrationActivityGroup.this);
